...
// 速度修正比例系数
#define SPEED_REVISE_RATIO               (1.01f)
// 轮脉冲比例系数
#define WHEEL_PUSLE_RATIO                (0.021654f)
/****/
...
#define SENSOR5_ANGLE ( 3.1415926535897932384626433832795f )

#define SENSOR6_X     (-1.08f )
#define SENSOR6_Y     ( 0.32f )
#define SENSOR6_ANGLE ( 3.1415926535897932384626433832795f )

#define SENSOR7_X     (-1.08f )
#define SENSOR7_Y     (-0.32f )
#define SENSOR7_ANGLE ( 3.1415926535897932384626433832795f )

#define SENSOR8_X     (-1.02f )
#define SENSOR8_Y     (-0.69f )
#define SENSOR8_ANGLE ( 3.1415926535897932384626433832795f )

#define SENSOR9_X     ( 3.15f )
#define SENSOR9_Y     ( 0.90f )
#define SENSOR9_ANGLE (1.5707963267948966192313216916398f )

#define SENSOR10_X     ( 3.15f )
#define SENSOR10_Y     (-0.90f )
#define SENSOR10_ANGLE (-1.5707963267948966192313216916398f )

#define SENSOR11_X     (-0.32f)
#define SENSOR11_Y     ( 0.90f)
#define SENSOR11_ANGLE (1.5707963267948966192313216916398f)

#define SENSOR12_X     (-0.32f)
#define SENSOR12_Y     (-0.90f)
#define SENSOR12_ANGLE (-1.5707963267948966192313216916398f)
