...
public:
     ...
     */
    HC_CC_RS_Path* HCPM0_CirclesReedsSheppPath(HC_CC_Circle &c1, HC_CC_Circle &c2);
     ...
     */
    HC_CC_RS_Path* HCPM0_ReedsSheppPath(const State &state1, const State &state2);
