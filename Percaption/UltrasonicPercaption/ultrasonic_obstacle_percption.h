...
public:
    ...
    void EdgeFinding_V1_1(LinkList *list,LinkList *vehicle_list);//增加车辆链表
    // 求取最高分布值的最优解
    ...
    void ParaParkingEdgeReCalculate();
    void ParaForceStop();
...
private:
    ...
    LinkList *_ultrasonic_front_vehicle_edge_list;
    ...
    // To recalculate the edge, parallel parking
    _para_edge_list _para_rear_edge_list,_para_wall_edge_list;
